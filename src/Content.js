...
class Content extends Component {
  render() {
    return (
     ...
     <p>I love to learn new languages, I am very interested in blockchain. I love Snooker and motorbikes, while I have always loved superbikes I have now chaged focus towards Harley Davidson</p>
    </div>
    );
  }
}
